...
001 to 013 are done and sit in `completed/`. The data and the arithmetic are finished: the estate, the equipment and twelve weeks of scores are in Neon, with nineteen members in the High band at the most recent date. 004 was reopened by 006 as expected, and its file carries the amendment. The shell and the design language are in place, so the screens are layout rather than design. Both features are built. 010 put the model behind a deployed endpoint, 011 wired it to the queue, 012 recorded what a person decided about what came back, and 013 wrote the briefing that the equipment data exists for. 006 was amended after 011 found a scoring rule that misfired on members inside twelve weeks.
